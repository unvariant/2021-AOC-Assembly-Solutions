...
;qword[rsp + 24] bool determines whether or not small caves can be visited twice
...
mov qword[rsp + 24], 0   ;initalize loop counter
mov qword[rsp + 32], rax ;save visited nodes
.branchloop:

mov rcx, qword[rsp + 24]   ;get loop counter
mov rdi, qword[rsp + 48]   ;get current node
